                                           ...
                                           const G4Step& stepData)
{
  ...
  if(kineticEnergy < MinKineticEnergy) {
    ...
    //    eloss = kineticEnergy ; //RICARDO: i don't want to deposit below CUT
  ...
  if (finalT/**massRatio*/ <= MinKineticEnergy ) { //RICARDO: Tp=10eV => Xe=1.31keV and i want CUT=10eV
  ...
  //  eloss = kineticEnergy-finalT; //RICARDO: finalT=0 in the last step and i don't want to deposit
  ...
  aParticleChange.ProposeLocalEnergyDeposit(eloss+nloss); //RICARDO: pq alterei em cima na linha 994
