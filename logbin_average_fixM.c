...
#define MAX 2.301029996 /* limite maximo FIXO da energia ou beta */
#define MIN -1.995248844 /* limite minimo FIXO da energia ou beta */
...
{
  char f_out[50],*name="_logbin_average_fixM.dat";
  FILE *fp_in,*fp_out;
  int n,j=0,l;
  long int N,i,ni=0;
  double **v,min,max;
...
void joao_viana(FILE *fp,double **v,long int N,double *min,double *max)
{
  ...
  *min=MIN;*max=MAX; /* min e max fixos */
